...
export function Observability() {
  ...
  const metrics = [
    { label: 'Taux d\'échec', value: 2.3, unit: '%', icon: Activity, gradient: 'from-red-500 to-orange-500', max: 10 },
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-orange-800 dark:text-orange-200">
                  45 jobs en attente. Considérez l'ajout de workers supplémentaires.
                </div>
              </div>
