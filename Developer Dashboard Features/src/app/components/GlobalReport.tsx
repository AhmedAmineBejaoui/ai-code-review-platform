...
import { mockAnalyses, currentUser } from "../data/mockData";
...
export function GlobalReport() {
  ...
  const maxRisk = 100;
  const riskLevel = riskScore > 30 ? 'Élevé' : riskScore > 10 ? 'Moyen' : 'Faible';
        ...
        <Card className="relative overflow-hidden bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/30 dark:to-purple-950/30 backdrop-blur-xl border-blue-200/50 dark:border-blue-800/50">
          ...
          <CardContent className="space-y-4 relative z-10">
            <p className="text-gray-700 dark:text-gray-300">
              Cette PR introduit des modifications dans le système d'authentification et de recherche utilisateur.
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {[
                { label: 'Fichiers modifiés', value: '5', gradient: 'from-blue-500 to-cyan-500' },
      ...
      >
        <Card className="bg-white/50 dark:bg-gray-900/50 backdrop-blur-xl border-gray-200/50 dark:border-gray-800/50">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {[
                { icon: Shield, label: 'Sécurité', count: categoryFindings.security.length, color: 'text-red-600 dark:text-red-400', bg: 'from-red-500 to-orange-500' },
                ...
                { icon: Code2, label: 'Maintenabilité', count: categoryFindings.maintainability.length, color: 'text-blue-600 dark:text-blue-400', bg: 'from-blue-500 to-purple-500' },
              ].map((category, index) => (
                <motion.div
                  key={category.label}
                  initial={{ opacity: 0, y: 20 }}
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-400">
                      {category.count} problème(s) détecté(s)
                    </div>
                  </div>
                </motion.div>
              ))}
      ...
      >
        <Card className="bg-white/50 dark:bg-gray-900/50 backdrop-blur-xl border-gray-200/50 dark:border-gray-800/50">
          ...
          <CardContent>
            <div className="space-y-3">
              {[
                { icon: AlertCircle, title: 'Critique - Action immédiate', desc: 'Corrigez les 2 problèmes de sécurité BLOCKER avant de merger cette PR.', bg: 'from-red-50 to-orange-50 dark:from-red-950/30 dark:to-orange-950/30', border: 'border-red-200/50 dark:border-red-800/50', text: 'text-red-900 dark:text-red-100', iconColor: 'text-red-600 dark:text-red-400' },
                { icon: AlertTriangle, title: 'Recommandé', desc: 'Ajoutez des tests unitaires et optimisez les requêtes de base de données.', bg: 'from-orange-50 to-yellow-50 dark:from-orange-950/30 dark:to-yellow-950/30', border: 'border-orange-200/50 dark:border-orange-800/50', text: 'text-orange-900 dark:text-orange-100', iconColor: 'text-orange-600 dark:text-orange-400' },
                { icon: Info, title: 'Amélioration', desc: 'Améliorez la documentation et remplacez les magic numbers par des constantes.', bg: 'from-blue-50 to-purple-50 dark:from-blue-950/30 dark:to-purple-950/30', border: 'border-blue-200/50 dark:border-blue-800/50', text: 'text-blue-900 dark:text-blue-100', iconColor: 'text-blue-600 dark:text-blue-400' },
              ].map((rec, index) => (
                <motion.div
                  key={rec.title}
                  initial={{ opacity: 0, x: -20 }}
          ...
          <Card className="relative overflow-hidden bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-950/30 dark:to-blue-950/30 backdrop-blur-xl border-2 border-purple-200/50 dark:border-purple-800/50">
            ...
            <CardContent className="relative z-10">
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400 mt-4 text-center">
                Cette décision sera enregistrée et notifiée à l'auteur de la PR
              </p>
            </CardContent>
          </Card>
        </motion.div>
