...
export function DeveloperDashboard() {
  ...
  const recentAnalyses = currentUser.role === 'dev' 
    ? mockAnalyses.filter(a => a.author === currentUser.name).slice(0, 5)
    : mockAnalyses.slice(0, 5);
      ...
      <motion.div className="grid md:grid-cols-3 gap-6" variants={item}>
        ...
        <motion.div whileHover={{ y: -4 }} transition={{ duration: 0.2 }}>
          <Card className="relative overflow-hidden border-green-500/20 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 backdrop-blur-xl">
            ...
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium text-gray-700 dark:text-gray-300">Analyses réussies</CardTitle>
              <motion.div 
        ...
        <Card className="bg-white/50 dark:bg-gray-900/50 backdrop-blur-xl border-gray-200/50 dark:border-gray-800/50">
          ...
          <CardContent>
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex-1 min-w-[200px]">
                <label className="text-sm text-gray-600 dark:text-gray-400 mb-2 block">Période</label>
              ...
              <div className="flex-1 min-w-[200px]">
                <label className="text-sm text-gray-600 dark:text-gray-400 mb-2 block">Sévérité</label>
