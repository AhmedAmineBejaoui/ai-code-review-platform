...
const allPermissions = [
  { id: 'manage_kb', label: 'Gérer la base de connaissance', gradient: 'from-emerald-500 to-teal-500' },
  { id: 'override_severity', label: 'Modifier la sévérité', gradient: 'from-orange-500 to-red-500' },
...
export function UserManagement() {
  ...
  const stats = [
    ...
    { label: 'Développeurs', value: mockUsers.filter(u => u.role === 'dev').length, icon: Users, gradient: 'from-green-500 to-emerald-500' },
  ];
        ...
        <Card className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950/30 dark:to-pink-950/30 backdrop-blur-xl border-purple-200/50 dark:border-purple-800/50">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Gérez les tokens d'accès API pour les utilisateurs et les intégrations CI/CD.
            </p>
