    ...
    >
      ...
      >
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Sources utilisées par l'IA pour générer les recommandations
        </p>
      </motion.div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-blue-900 dark:text-blue-100 mb-2 flex items-center gap-2">
                  ...
                  À propos des citations RAG
                </h3>
                <p className="text-sm text-blue-800 dark:text-blue-200">
                  Ces extraits proviennent de la base de connaissances et ont été utilisés pour
                  contextualiser les recommandations de l'IA. Le score de pertinence indique
                  la correspondance entre le document et le problème détecté.
                </p>
              </div>
            </div>
          </CardContent>
      ...
      >
        <Card className="bg-white/50 dark:bg-gray-900/50 backdrop-blur-xl border-gray-200/50 dark:border-gray-800/50">
          <CardHeader>
            <CardTitle className="text-base">Sources supplémentaires consultées</CardTitle>
          </CardHeader>
          <CardContent>
