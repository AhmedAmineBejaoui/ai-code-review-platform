"""
Security routes - Security issues tracking and dashboard.

Extracted from: apps/backend/app/api/http/security.py
"""
...
def _finding_to_security_issue(row: dict) -> SecurityIssue:
    ...
    issue_status = "open"  # Could be enhanced with actual status tracking
...
async def update_issue_status(
    ...
    with engine.connect() as conn:
        ...
        return SecurityIssue(
            ...
            resolved_by=user_id if request.status == "resolved" else None,
        )
