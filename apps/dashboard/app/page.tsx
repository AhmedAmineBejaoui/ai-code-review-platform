...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#0C0C0D] text-[#F5F5F5] overflow-x-hidden">
        ...
        <div className="max-w-8xl mx-auto px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link 
                href="/sign-up"
                className="inline-flex items-center gap-1 px-4 py-2 rounded-full border border-[rgba(255,255,255,0.06)] bg-transparent text-sm font-medium text-[#F5F5F5] hover:bg-[rgba(255,255,255,0.05)] transition-all"
              >
      ...
      {/* ═══════════════════════════════════════════
          SECTION 3: Hero Section (Asymmetric)
          ═══════════════════════════════════════════ */}
      <section className="relative px-8 pt-16 pb-12 md:pt-20 md:pb-16">
        <div className="max-w-8xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <motion.div
              ...
              className="max-w-xl"
            >
              <h1 className="hero-title text-[#F5F5F5] text-left mb-6">
                The next generation<br />
                of code review.
              </h1>
              
              <p className="body-text text-[#A0A0A8] mb-8 max-w-md">
              ...
              <div className="flex flex-wrap items-center gap-3 mb-4">
                <Link 
                  href="/sign-up"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#E8713A] text-white text-sm font-medium hover:brightness-110 transition-all"
                >
                  Get started for free <ArrowRight className="w-4 h-4" />
                </Link>
                <Link 
                  href="#"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-full border border-[rgba(255,255,255,0.06)] text-[#F5F5F5] text-sm font-medium hover:bg-[rgba(255,255,255,0.05)] transition-all"
                >
                  Request a demo
                </Link>
              </div>

              <p className="meta-text text-[#6B6B75]">
      ...
      {/* ═══════════════════════════════════════════
          SECTION 4: Trust Bar (Logo Marquee)
          ═══════════════════════════════════════════ */}
      <section className="py-8 px-8">
        <div className="max-w-8xl mx-auto">
          <div className="flex items-center gap-8">
            <p className="text-sm text-[#6B6B75] whitespace-nowrap min-w-fit">
              Trusted by leading<br />engineering teams at
            </p>
            ...
            <div className="flex-1 overflow-hidden">
              <div className="flex items-center gap-12 animate-marquee">
                {[...trustLogos, ...trustLogos].map((logo, idx) => (
                  <div 
                    key={`${logo.id}-${idx}`}
                    className="text-[#6B6B75] whitespace-nowrap opacity-60 hover:opacity-100 transition-opacity h-8 flex items-center"
                  >
                    <img 
                      src={logo.logo} 
                      alt={logo.name} 
      ...
      <section className="py-12 px-8">
        <div className="max-w-5xl mx-auto">
          <div className="relative rounded-[16px] overflow-hidden bg-[#141416] border border-[rgba(255,255,255,0.08)]">
            ...
            <div className="aspect-video bg-[#0C0C0D] relative flex items-center justify-center overflow-hidden">
              ...
              {/* Play button */}
              <button className="relative z-10 inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white text-[#0C0C0D] text-sm font-medium hover:bg-gray-100 transition-all shadow-lg">
                <Play className="w-4 h-4 fill-current" />
                Play
              </button>

              {/* Video title */}
              <div className="absolute bottom-6 left-6 text-2xl font-semibold text-white">
                Intro to AI Code Review
              </div>
            </div>

            {/* Tab bar */}
            <div className="flex items-center gap-2 p-3 overflow-x-auto bg-[#141416] border-t border-[rgba(255,255,255,0.06)]">
              {videoTabs.map((tab) => (
                <button
                  key={tab.id}
      ...
      {/* ═══════════════════════════════════════════
          SECTION 6: Customer Stories Carousel
          ═══════════════════════════════════════════ */}
      <section className="py-16 px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {customerStories.map((story) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className={`relative rounded-[16px] overflow-hidden ${story.bgColor} aspect-[4/3] group cursor-pointer hover:-translate-y-1 transition-transform duration-300`}
              >
                {/* Background image */}
                <img 
                  src={story.bgImage} 
                ...
                <div className="absolute inset-0 flex items-center justify-center p-8">
                  <span className={`text-3xl font-bold ${story.textColor}`}>
                    {story.company}
                  </span>
                </div>
          ...
          <div className="flex items-center justify-center gap-3 mt-8">
            <button className="w-10 h-10 rounded-full border border-[rgba(255,255,255,0.06)] flex items-center justify-center text-[#6B6B75] hover:text-[#F5F5F5] hover:border-[rgba(255,255,255,0.15)] transition-all">
      ...
      {/* ═══════════════════════════════════════════
          SECTION 7: Feature Showcase (Vertical Accordion)
          ═══════════════════════════════════════════ */}
      <section className="py-16 px-8">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-[20px] border border-[rgba(255,255,255,0.08)] bg-[#141416] overflow-hidden">
            {/* Plus decorators */}
            <span className="absolute top-4 left-4 text-[#4A4A54] text-sm">+</span>
            <span className="absolute top-4 right-4 text-[#4A4A54] text-sm">+</span>
            <span className="absolute bottom-4 left-4 text-[#4A4A54] text-sm">+</span>
            <span className="absolute bottom-4 right-4 text-[#4A4A54] text-sm">+</span>
            ...
            <div className="grid md:grid-cols-[1fr,380px]">
              ...
              <div className="p-8 md:p-12 flex items-center justify-center min-h-[400px]">
                <div className="w-full max-w-lg rounded-lg bg-[#0C0C0D] border border-[rgba(255,255,255,0.06)] overflow-hidden">
              ...
              <div className="border-l border-[rgba(255,255,255,0.06)]">
                {featureShowcaseItems.map((item) => (
                  <button
                    key={item.id}
                    onClick={() => setActiveFeature(item.id)}
                    className={`w-full text-left p-6 border-b border-[rgba(255,255,255,0.06)] last:border-b-0 transition-all ${
                      activeFeature === item.id
                        ? "border-l-[3px] border-l-[#E8713A] bg-[rgba(232,113,58,0.05)]"
                        : "border-l-[3px] border-l-transparent hover:bg-[rgba(255,255,255,0.02)]"
                    }`}
                  >
      ...
      {/* ═══════════════════════════════════════════
          SECTION 8: Feature Grid ("Everything you need")
          ═══════════════════════════════════════════ */}
      <section className="py-16 px-8">
        <div className="max-w-6xl mx-auto">
          <motion.div
          ...
          <div className="grid gap-4">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="rounded-[16px] bg-[#141416] border border-[rgba(255,255,255,0.08)] p-8 hover:border-[rgba(232,113,58,0.3)] hover:-translate-y-1 transition-all duration-300"
            >
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    <Link 
                      href="#"
                      className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#E8713A] text-white text-sm font-medium hover:brightness-110 transition-all"
                    >
                      Start stacking
                    </Link>
                    <Link 
                ...
                <div className="bg-[#0C0C0D] rounded-lg p-4 font-mono text-sm">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <motion.div
                ...
                className="rounded-[16px] bg-[#141416] border border-[rgba(255,255,255,0.08)] p-6 hover:border-[rgba(232,113,58,0.3)] hover:-translate-y-1 transition-all duration-300"
              >
                ...
                <div className="flex gap-6">
                  ...
                  <div className="flex flex-col gap-2">
                    {platformPills.map((pill) => (
                      <div 
                        key={pill.label}
                        className="inline-flex items-center gap-2 px-3 py-2 rounded-full bg-[#222226] border border-[rgba(255,255,255,0.06)] text-sm text-[#F5F5F5]"
                      >
      ...
      {/* ═══════════════════════════════════════════
          SECTION 11: Integration Section
          ═══════════════════════════════════════════ */}
      <section className="py-16 px-8">
        <div className="max-w-6xl mx-auto">
          <motion.div
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="flex justify-center">
              <div className="relative w-[300px] h-[300px]">
                ...
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-48 h-32 bg-[#141416] rounded-lg border border-[rgba(255,255,255,0.08)] transform rotate-[-5deg] flex items-center justify-center shadow-lg">
                  <img src="/landing/logos/slack.svg" alt="Slack" className="w-10 h-10 text-[#A0A0A8]" style={{ filter: "invert(0.7)" }} />
                </div>
                <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-48 h-32 bg-[#141416] rounded-lg border border-[rgba(255,255,255,0.08)] transform rotate-[2deg] flex items-center justify-center shadow-lg">
                  <img src="/landing/logos/github.svg" alt="GitHub" className="w-10 h-10" style={{ filter: "invert(0.7)" }} />
                </div>
                <div className="absolute bottom-16 left-1/2 -translate-x-1/2 w-48 h-32 bg-[#141416] rounded-lg border border-[rgba(255,255,255,0.08)] flex items-center justify-center shadow-lg">
                  <img src="/landing/logos/vscode.svg" alt="VS Code" className="w-10 h-10" style={{ filter: "invert(0.7)" }} />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8">
              <div className="border-l-2 border-[#4A4A54] pl-6">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="section-title text-[#F5F5F5] mb-8">
              Built for the world&apos;s fastest engineering<br />
      ...
      {/* ═══════════════════════════════════════════
          SECTION 13: Footer
          ═══════════════════════════════════════════ */}
      <footer className="py-16 px-8 border-t border-[rgba(255,255,255,0.06)]">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            ...
            {/* Features */}
            <div>
              <h4 className="text-sm font-semibold text-[#F5F5F5] mb-4">Features</h4>
            ...
            {/* Company */}
            <div>
              <h4 className="text-sm font-semibold text-[#F5F5F5] mb-4">Company</h4>
              <ul className="space-y-2">
            ...
            {/* Resources */}
            <div>
              <h4 className="text-sm font-semibold text-[#F5F5F5] mb-4">Resources</h4>
              <ul className="space-y-2">
            ...
            {/* Connect */}
            <div>
              <h4 className="text-sm font-semibold text-[#F5F5F5] mb-4">Connect</h4>
              <ul className="space-y-2">
          ...
          <div className="mt-16 flex justify-center">
            <div className="relative">
              <h2 
                className="text-[80px] md:text-[120px] font-bold tracking-tighter text-transparent"
                style={{
