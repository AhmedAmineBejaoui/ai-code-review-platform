...
export function PoliciesRules() {
  ...
  const categories = [
    { id: 'security', label: 'Security', desc: 'Vuln̩rabilit̩s et probl̬mes de s̩curit̩', gradient: 'from-red-500 to-orange-500' },
    { id: 'performance', label: 'Performance', desc: 'Optimisations et goulots d\'̩tranglement', gradient: 'from-orange-500 to-yellow-500' },
    { id: 'quality', label: 'Quality', desc: 'Bonnes pratiques et qualit̩ du code', gradient: 'from-blue-500 to-cyan-500' },
    { id: 'maintainability', label: 'Maintainability', desc: 'Maintenabilit̩ et lisibilit̩ du code', gradient: 'from-purple-500 to-pink-500' },
  ];
  ...
  return (
    ...
    >
        ...
        <Card className="bg-white/50 dark:bg-gray-900/50 backdrop-blur-xl border-gray-200/50 dark:border-gray-800/50">
          ...
          <CardContent className="space-y-6">
            ...
            >
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Bloquer la PR si des probl̬mes BLOCKER sont d̩tect̩s
                </p>
              </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Limite le nombre de commentaires pour ̩viter de surcharger la PR
              </p>
            </div>
          </CardContent>
        </Card>
      ...
      >
        <Card className="bg-white/50 dark:bg-gray-900/50 backdrop-blur-xl border-gray-200/50 dark:border-gray-800/50">
          <CardHeader>
            <CardTitle>Cat̩gories actives</CardTitle>
          </CardHeader>
      ...
      >
        <Card className="bg-white/50 dark:bg-gray-900/50 backdrop-blur-xl border-gray-200/50 dark:border-gray-800/50">
          ...
          <CardContent className="space-y-4">
            <div>
              <Label>Chemins ignor̩s (glob patterns)</Label>
              <Textarea
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                Un pattern par ligne. Les fichiers correspondants seront ignor̩s lors de l'analyse.
              </p>
            </div>
          </CardContent>
        </Card>
      ...
      >
        <Card className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/30 dark:to-purple-950/30 backdrop-blur-xl border-blue-200/50 dark:border-blue-800/50">
          <CardHeader>
            <CardTitle>R̬gles par repository</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <Label>Profil de s̩v̩rit̩</Label>
                <Select defaultValue="strict">
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="moderate">Mod̩r̩</SelectItem>
                    <SelectItem value="relaxed">D̩tendu (dev)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
