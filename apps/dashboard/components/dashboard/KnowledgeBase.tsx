...
export function KnowledgeBase() {
  ...
  const stats = [
    ...
    { label: 'Index̩s', value: mockKbDocuments.filter(d => d.status === 'indexed').length, icon: Database, gradient: 'from-purple-500 to-pink-500' },
    { label: 'Obsol̬tes', value: mockKbDocuments.filter(d => d.status === 'outdated').length, icon: Database, gradient: 'from-orange-500 to-red-500' },
  ];
      ...
      >
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Gestion des documents utilis̩s par le RAG
          </p>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <Select defaultValue="incremental">
                  ...
                  <SelectContent>
                    <SelectItem value="full">Full (compl̬te)</SelectItem>
        ...
        <Card className="bg-white/50 dark:bg-gray-900/50 backdrop-blur-xl border-gray-200/50 dark:border-gray-800/50">
          <CardHeader>
            <div className="flex items-center gap-4">
              <CardTitle className="flex-1">Documents index̩s</CardTitle>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-gray-50/50 dark:bg-gray-800/50 hover:bg-gray-50/50 dark:hover:bg-gray-800/50">
                    ...
                    <TableHead>Derni̬re indexation</TableHead>
            ...
            <div className="space-y-4">
              <div>
                <label className="text-sm text-gray-600 dark:text-gray-400 mb-2 block">
                  Entrez une requ̻te pour tester la recherche RAG
                </label>
                <Input 
