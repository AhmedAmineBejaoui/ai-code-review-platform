              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                    GitHub App installÃ©e â€¢ 3 organisations â€¢ 12 repositories
                  </p>
          ...
          <CardContent className="space-y-6">
            ...
            >
              <div className="space-y-1">
                <Label className="text-base">IntÃ©gration CI active</Label>
                <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            >
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Faire Ã©chouer le build CI si des BLOCKER sont dÃ©tectÃ©s
                </p>
              </div>
              <motion.div whileTap={{ scale: 0.9 }}>
            ...
            <div className="p-4 bg-white dark:bg-gray-900/50 rounded-xl border border-blue-200/50 dark:border-blue-800/50">
              <p className="text-sm font-medium text-gray-900 dark:text-white mb-3 flex items-center gap-2">
                ...
                Exemple d'intÃ©gration GitHub Actions
              </p>
          ...
          <CardContent className="space-y-4">
            ...
            >
              ...
              <div className="text-sm text-green-800 dark:text-green-200">
                Connexion vÃ©rifiÃ©e avec succÃ¨s â€¢ DerniÃ¨re vÃ©rification: il y a 2 minutes
              </div>
            </motion.div>
          </CardContent>
        </Card>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                        Dernier Ã©vÃ©nement: {webhook.event} â€¢ Il y a {webhook.time}
                      </p>
                    </div>
                  </div>
